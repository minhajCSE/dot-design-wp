...
$of_options[] = array( 	"name" 		=> "logo Uploader",
						"desc" 		=> "You should upload the logo in between 191px and 68px ",
						"id" 		=> "logo_uploader",
						"type" 		=> "upload"
				);
$of_options[] = array( 	"name" 		=> "Text Uploader",
						"desc" 		=> "Upload your slider bottom text here using native media uploader.",
						"id" 		=> "slider_bottom_text_upload",
						"std" 		=> "",
						"type" 		=> "text"
				);
$of_options[] = array( 	"name" 		=> "Heading Text Uploader",
						"desc" 		=> "Upload your heading in the about page.",
						"id" 		=> "about_us_heading",
						"std" 		=> "",
						"type" 		=> "text"
				);
$of_options[] = array( 	"name" 		=> "Para Text Uploader",
		"desc" 		=> "Upload your paragraph in the about page.",
		"id" 		=> "about_us_para",
		"std" 		=> "",
		"type" 		=> "text"
         );
$of_options[] = array( 	"name" 		=> "Footer logo Uploader",
				"desc" 		=> "You should upload the logo in between 191px and 68px ",
